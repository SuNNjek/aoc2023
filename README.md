...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `513.4µs` | `518.2µs` |
| [Day 2](./src/bin/02.rs) | `75.3µs` | `76.4µs` |
| [Day 3](./src/bin/03.rs) | `5.0ms` | `2.0ms` |
| [Day 4](./src/bin/04.rs) | `438.8µs` | `2.5s` |
| [Day 5](./src/bin/05.rs) | `21.7µs` | `11.4s` |
| [Day 6](./src/bin/06.rs) | `459.0ns` | `327.0ns` |
